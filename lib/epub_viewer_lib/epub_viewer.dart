...
import 'package:elearn/epub_viewer_lib/model/epub_locator.dart';
...
class EpubViewer {
  static const MethodChannel _channel =
      MethodChannel('vocsy_epub_viewer');
  ...
  static void setConfig(
    ...
    String hexColor;
    try {
      // Usa toARGB32 para evitar o membro deprecated `value`
      final int argb = themeColor.toARGB32();
      hexColor = '#${argb.toRadixString(16).padLeft(8, '0')}';
    } catch (e) {
      hexColor = '#FF0000FF'; // Fallback para azul se a conversão falhar
    }
