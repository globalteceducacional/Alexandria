...
Color buttonColorAccent = const Color(0xffffffff);
...
Color comboToggleButtonColor() {
  return mode.value == false ? kLightThemeBackGroundColor : const Color(0xFf34323d);
}

Color comboToggleBackgroundColor() {
  return mode.value == false ? const Color(0xFFe7e7e8) : const Color(0xFF222029);
}

Color comboLightGreyAndGrey() {
  return mode.value == false ? const Color(0xffb3b2b6) : const Color(0xff8c8989);
}

Color comboGreyAndBlack() {
  return mode.value ? const Color.fromARGB(138, 255, 255, 255) : const Color.fromARGB(138, 0, 0, 0);
}

Color comboWhiteAndLightViolet() {
  return mode.value == false ? const Color(0xFF26242e) : kLightThemeBackGroundColor;
}

Color shimmerBaseColor() {
  return mode.value == false
      ? Colors.grey.shade300
      : const Color.fromARGB(25, 255, 255, 255); // 0.1 * 255 ≈ 25
}

Color shimmerHighlightColor() {
  return mode.value == false
      ? Colors.grey.shade100
      : const Color.fromARGB(204, 0, 0, 0); // 0.8 * 255 ≈ 204
}
