...
ExploreLatestBook exploreLatestBookFromJson(String str) =>
    ExploreLatestBook.fromJson(json.decode(str));

String exploreLatestBookToJson(ExploreLatestBook data) =>
    json.encode(data.toJson());

class ExploreLatestBook {
  ExploreLatestBook({
  ...
  factory ExploreLatestBook.fromJson(Map<String, dynamic> json) =>
      ExploreLatestBook(
